...
import { shoes, statistics } from '../constance/index.js';
  ...
  const [bigShoeImg, setBigShoeImg] = useState(bigShoe1);
    ...
    return (
        ...
        >
           ...
           <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-6 font-bold">
           <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">The New Arrival</span>
           <br />
           <span className="text-coral-red inline-block mt-3">Nike </span> Shoes
           </h1>
           <p className="text-xl text-slate-gray leading-8 my-8 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innovation for your active life</p>
           <Button
            label='Show Now'
           ></Button>
